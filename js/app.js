(() => {
    ...
    function initSliders() {
        if (document.querySelector(".slider-hero")) new swiper_core_Swiper(".slider-hero", {
            ...
            pagination: {
                el: ".hero-slide-action__pagination",
                clickable: false
            },
            navigation: {
                prevEl: ".hero-slide-action__button-prev",
                nextEl: ".hero-slide-action__button-next"
            },
            on: {}
        });
        if (document.querySelector(".main-project__slider") && document.querySelector(".thumbs-project__slider")) {
            let thumbsProject = new swiper_core_Swiper(".thumbs-project__slider", {
                modules: [],
                observer: true,
                observeParents: true,
                slidesPerView: 5,
            ...
            new swiper_core_Swiper(".main-project__slider", {
                ...
                navigation: {
                    prevEl: ".main-project__button-prev",
                    nextEl: ".main-project__button-next"
                },
                thumbs: {
    ...
    console.log;
    (() => {
        function insertNumberOfHeroSlider() {
            const getSlideHero = document.querySelectorAll(".slide-hero");
            let setSlideCounter = getSlideHero.length;
            setSlideCounter < 10 ? setSlideCounter = "0" + setSlideCounter : setSlideCounter;
            const getPaginationNumberStart = document.querySelector(".hero-slide-action__number-start");
            const getPaginationNumberEnd = document.querySelector(".hero-slide-action__number-end");
            getPaginationNumberStart.innerHTML = "01";
            getPaginationNumberEnd.innerHTML = setSlideCounter;
        }
        if (document.querySelector(".hero__slider")) insertNumberOfHeroSlider();
    })();
    (() => {
        function hiddenVisibleByClickAdvantagesHero(getSliderHero, getBtn) {
            ...
            if (setClassListSliderHero.includes("slider-hero__advantages_open")) {
                ...
                getSliderHero.classList.add("slider-hero__advantages_open");
                getBtn.innerHTML = "Скрыть";
            }
        }
        if (document.querySelector(".hero__slider")) {
            let getSliderHero = document.querySelector(".slider-hero");
            let getBtn = getSliderHero.querySelector(".advantages-hero__btn");
            getBtn.addEventListener("click", (() => {
                hiddenVisibleByClickAdvantagesHero(getSliderHero, getBtn);
            }));
        }
    })();
    (() => {
